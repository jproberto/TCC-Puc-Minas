...
public class SicaSegurancaComunicacaoApplication implements CommandLineRunner {
	...
	private void resetaBanco() {
		...
		procedimento1.setContatoEmergencia("John Doe");
		...
		destinatario1.setNomeResponsavel("Jane Doe");
		...
		localidade1.setNome("Vilarejo de Boaventura");
		localidade1.setQuantidadeHabitantes(1000L);
		localidade1.setTipo(TipoLocalidade.VILA);
		...
		destinatario2.setNomeResponsavel("José de Oleracea");
		destinatario2.setTelefone("2345678");
		destinatario2.setEmail("oleracea.jose@gmail.com");
		...
		barragem2.setCodigo("BB2");
		barragem2.setNome("Barragem Barrística");
		barragem2.adicionaLocalidadeProxima(localidade1);
		barragem2.adicionaLocalidadeProxima(localidade2);
		
		repository.save(barragem2);
	}
}
